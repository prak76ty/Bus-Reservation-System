...
Public Class AdvanceBookingCancellation
    ...
    Private Sub BName_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BName.Click
        ...
        Try
            ...
            Else
                con = New SqlConnection("Data Source=.\SQLEXPRESS;Initial Catalog=Bus_System;Integrated Security=True")
                con.Open()
                cmd = New SqlCommand("Select * From APaymentPassenger Where PassengerName='" & BookedName1.Text & "' and BookingDate='" & Format(BookingDate.Value, "dd/MM/yyyy") & "'", con)
                dr = cmd.ExecuteReader
                dr.Read()
    ...
    Sub CheckSeats()
        ...
        If SeatType = "L" Then
            check = "1"
            cmd = New SqlCommand("Select BookingNo,BDate,SeatNo,SeatType From APassengerDetails where BookingNo=" & BookingNo1.Text & " and BDate='" & Format(BDate.Value, "dd/MM/yyyy") & "' and SeatNo='" & check & "' and SeatType='" & SeatType & "'", con)
            dr = cmd.ExecuteReader
            dr.Read()
            If dr.HasRows Then
        ...
        Else
            ...
            If res = DialogResult.Yes Then
                ...
                Try
                    ...
                    con = New SqlConnection("Data Source=.\SQLEXPRESS;Initial Catalog=Bus_System;Integrated Security=True")
                    con.Open()
                    cmd = New SqlCommand("Select * From APassengerDetails Where BookingNo=" & BookingNo1.Text & " and BDate='" & Format(BDate.Value, "dd/MM/yyyy") & "'", con)
                    dr = cmd.ExecuteReader
                    dr.Read()
                    BNO1 = dr.GetValue(0)
                    dr.Close()
