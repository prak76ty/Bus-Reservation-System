...
Public Class CompletedSB
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            ...
            con = New SqlConnection("Data Source=.\SQLEXPRESS;Initial Catalog=Bus_System;Integrated Security=True")
            con.Open()
            cmd = New SqlCommand("Select * From CompletedPP Where BookingDate='" & Format(BookingDate.Value, "dd/MM/yyyy") & "'", con)
            dr = cmd.ExecuteReader
            i = 0
            While dr.Read
                DGV.Rows.Add()
            ...
            con = New SqlConnection("Data Source=.\SQLEXPRESS;Initial Catalog=Bus_System;Integrated Security=True")
            con.Open()
            cmd = New SqlCommand("Select * From CompletedPassenger Where BDate='" & Format(BookingDate.Value, "dd/MM/yyyy") & "'", con)
            dr = cmd.ExecuteReader
            i = 0
            While dr.Read
                DGV2.Rows.Add()
