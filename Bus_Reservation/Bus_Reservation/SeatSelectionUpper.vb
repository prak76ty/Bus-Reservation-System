...
Public Class SeatSelectionUpper
    ...
    Private Sub Button22_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button22.Click
        If checkm = "NA" Then
            Dim SSL0 As New SeatSelectionLower("NA", "NA", RNO.Text, BNO.Text)
            SSL0.BringToFront()
            SSL0.Show()
        Else
            Dim SSL1 As New SeatSelectionLower("AB_UN", BookingNo.Text, RNO.Text, BNO.Text)
            SSL1.BringToFront()
            SSL1.Show()
        End If
    End Sub
