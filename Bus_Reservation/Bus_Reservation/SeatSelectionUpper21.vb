...
Public Class SeatSelectionUpper21
    ...
    Private Sub Button22_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button22.Click
        If checkm = "NA" Then
            Dim SSU0 As New SeatSelectionLower21("NA", "NA", RNO.Text, BNO.Text)
            SSU0.BringToFront()
            SSU0.Show()
        Else
            Dim SSU1 As New SeatSelectionLower21("AB_UN", BookingNo.Text, RNO.Text, BNO.Text)
            SSU1.BringToFront()
            SSU1.Show()
        End If
    End Sub
