...
Public Class SeatSelectionUpper22
    ...
    Private Sub Button22_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button22.Click
        If checkm = "NA" Then
            Dim SSU0 As New SeatSelectionLower22("NA", "NA", RNO.Text, BNO.Text)
            SSU0.BringToFront()
            SSU0.Show()
        Else
            Dim SSU1 As New SeatSelectionLower22("AB_UN", BookingNo.Text, RNO.Text, BNO.Text)
            SSU1.BringToFront()
            SSU1.Show()
        End If
    End Sub
    Private Sub SeatSelectionUpper_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Insert_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Insert.Click
        ...
        Else
            ...
            ElseIf PaymentBy.Text = "Some Cash" Then
                ...
                If CheckBox31.Checked = True Then
                    SeatNo.Text = "31"
                    FareAmount.Text = Val(TextBox31.Text)
                    InsertDB()
                End If
                If CheckBox32.Checked = True Then
                    SeatNo.Text = "32"
                    FareAmount.Text = Val(TextBox32.Text)
                    InsertDB()
                End If
                If CheckBox33.Checked = True Then
                    SeatNo.Text = "33"
                    FareAmount.Text = Val(TextBox33.Text)
                    InsertDB()
                End If
                If CheckBox34.Checked = True Then
                    SeatNo.Text = "34"
                    FareAmount.Text = Val(TextBox34.Text)
                    InsertDB()
                End If
                If CheckBox35.Checked = True Then
                    SeatNo.Text = "35"
                    FareAmount.Text = Val(TextBox35.Text)
                    InsertDB()
                End If
                If CheckBox36.Checked = True Then
                    SeatNo.Text = "36"
                    FareAmount.Text = Val(TextBox36.Text)
                    InsertDB()
                End If
                If CheckBox37.Checked = True Then
                    SeatNo.Text = "37"
                    FareAmount.Text = Val(TextBox37.Text)
                    InsertDB()
                End If
                If CheckBox38.Checked = True Then
                    SeatNo.Text = "38"
                    FareAmount.Text = Val(TextBox38.Text)
                    InsertDB()
                End If
                If CheckBox39.Checked = True Then
                    SeatNo.Text = "39"
                    FareAmount.Text = Val(TextBox39.Text)
                    InsertDB()
                End If
                If CheckBox40.Checked = True Then
                    SeatNo.Text = "40"
                    FareAmount.Text = Val(TextBox40.Text)
                    InsertDB()
                End If
            End If
            MsgBox("DONE.. !!!")
        ...
        Try
            ...
            Else
                ...
                ElseIf DGV.Rows(i).Cells(4).Value = 30 Then
                    CheckBox30.Enabled = False
                ElseIf DGV.Rows(i).Cells(4).Value = 31 Then
                    CheckBox31.Enabled = False
                ElseIf DGV.Rows(i).Cells(4).Value = 32 Then
                    CheckBox32.Enabled = False
                ElseIf DGV.Rows(i).Cells(4).Value = 33 Then
                    CheckBox33.Enabled = False
                ElseIf DGV.Rows(i).Cells(4).Value = 34 Then
                    CheckBox34.Enabled = False
                ElseIf DGV.Rows(i).Cells(4).Value = 35 Then
                    CheckBox35.Enabled = False
                ElseIf DGV.Rows(i).Cells(4).Value = 36 Then
                    CheckBox36.Enabled = False
                ElseIf DGV.Rows(i).Cells(4).Value = 37 Then
                    CheckBox37.Enabled = False
                ElseIf DGV.Rows(i).Cells(4).Value = 38 Then
                    CheckBox38.Enabled = False
                ElseIf DGV.Rows(i).Cells(4).Value = 39 Then
                    CheckBox39.Enabled = False
                ElseIf DGV.Rows(i).Cells(4).Value = 40 Then
                    CheckBox40.Enabled = False
                End If
                i += 1
                Insert.Enabled = True
