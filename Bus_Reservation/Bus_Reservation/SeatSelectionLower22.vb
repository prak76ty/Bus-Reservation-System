...
Public Class SeatSelectionLower22
    ...
    Private Sub Button22_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button22.Click
        If checkm = "NA" Then
            Dim SSU0 As New SeatSelectionUpper22("NA", "NA", RNO.Text, BNO.Text)
            SSU0.BringToFront()
            SSU0.Show()
        Else
            Dim SSU1 As New SeatSelectionUpper22("AB_UN", BookingNo.Text, RNO.Text, BNO.Text)
            SSU1.BringToFront()
            SSU1.Show()
        End If
    End Sub
